...
INSERT INTO `authority` VALUES (1,'ROLE_SUPER_ADMIN'),(2,'ROLE_ADMIN'),(3,'ROLE_COMMON_STAFF'),(4,'ROLE_ADMIN_PLUS_');
...
CREATE TABLE `device` (
  ...
  `imei` varchar(32) NOT NULL UNIQUE COMMENT 'IMEI',
  `imsi` varchar(32) NOT NULL UNIQUE COMMENT 'IMSI',
